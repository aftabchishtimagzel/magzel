...
const Team = () => {
  ...
  return (
    ...
    <Grid container  width={{xs:"100%",md:"70%"}} justifyContent={"space-between"} mx={"auto"} gap={1} p={1}>
...
<Typography sx={{width:{xs:"100%",md:"60%"}}}>Join our academy to upgrade your knowledge and skills in the most popular programming languages, software practices, app development
, and a lot more. Our courses will show you the way from just knowing fundamentals to mastering cutting-edge technologies.</Typography>
      <Button sx={{width:"200px",marginTop:"15px"}} variant="outlined" endIcon={<ArrowRightAltIcon  />}>
  Learn More
</Button>
        </Stack>
        <Stack width={{xs:"100%",md:"50%"}}>
